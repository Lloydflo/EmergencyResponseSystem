    ...
    <style>
        ...
        .main-content {
            background:
                ...
                var(--ia-bg);
            /* Keep the Inter-Agency title below the fixed admin header. */
            padding: calc(var(--app-header-height-1) + 1rem) 1.5rem 2rem;
        }
        ...
        @media (max-width: 720px) {
            .main-content {
                padding: calc(var(--app-header-height-mobile-1) + 0.75rem) 0.8rem 1rem;
            }
