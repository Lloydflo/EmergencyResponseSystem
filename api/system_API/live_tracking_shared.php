...
// Shared query/route/Firebase helpers for the live tracking family of
// endpoints (live_tracking.php = full payload, live_tracking_simple.php =
// minimal payload for partners who just want lat/lng pairs). Split out so
// both endpoints reuse the exact same data instead of drifting apart.
